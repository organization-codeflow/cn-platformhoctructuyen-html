...
```bash
git clone https://github.com/organization-codeflow/cn-platformhoctructuyen-html.git
cd cn-platformhoctructuyen-html
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=cn-platformhoctructuyen-html
- Xem các metrics:
